...
--
-- Servidor: localhost
-- Tiempo de generación: 05-03-2015 a las 03:48:12
...
INSERT INTO `idioma` (`id`, `tiponivelingles_id`, `persona_id`, `fechainicio`, `fechafin`, `tipoinstitucion_id`, `archivo_id`, `profesor`, `creado_at`) VALUES
(2, 2, 12, '2015-03-05', '2015-03-06', 1, 17, 'ewarewre', '2015-03-01 12:09:54'),
(3, 2, 15, '2015-03-05', '2015-03-06', 1, 18, 'ewarewre', '2015-03-01 13:42:26'),
(4, 1, 12, '2015-03-12', '2015-03-06', 4, 19, 'gfdsgdfs', '2015-03-01 13:44:25');
...
INSERT INTO `investigacion` (`id`, `tiposemestre_id`, `fechainicio`, `fechafinesperada`, `fechafin`, `tipoestadoinvestigacion_id`, `archivo_id`, `titulo`, `creado_at`) VALUES
(2, 1, '2015-03-10', '2015-03-13', '2015-03-12', 1, 22, 'inv2', '2015-03-01 15:03:01'),
(3, 1, '2015-03-06', '2015-03-13', '2015-03-18', 1, 23, 'otra inv', '2015-03-04 21:00:27');
...
INSERT INTO `movilidad` (`id`, `tipomovilidad_id`, `tiposemestre_id`, `fechamovilidad`, `persona_id`, `areaconocimiento`, `nombreevento`, `tipoinstitucion_id`, `tipofinanciacion_id`, `descripcionexperiencia`, `archivo_id`, `creado_at`) VALUES
(3, 1, 2, '2015-02-05', 12, 'nose', 'edsfdsfd', 1, 2, 'nose', NULL, '2015-02-26 20:47:58'),
(4, 1, 1, '2005-01-01', 12, 'dsafads', 'dsfas', 1, 1, 'sareare', 15, '2015-02-26 20:57:23');
